...
def face_recognition(img1, dir_loc, model, dist, detector):
    ...
    # face recognition
    rec = DeepFace.find(img_path=img1, db_path=dir_loc, distance_metric=dist, model_name=model, detector_backend=detector)    
    return rec
...
def compare_json():
    ...
    if (content_type == 'application/json'):    
        ...
        verification_info = face_verification(img_1, img_2, metric, model, backend)
